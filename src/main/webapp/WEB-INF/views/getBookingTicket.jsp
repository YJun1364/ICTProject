...
<body>
	...
	<nav aria-label="breadcrumb">
		<ol class="breadcrumb">
			...
			<li class="breadcrumb-item active">자리선택</li>
				...
				<div class="card-img-overlay">
					...
					<div class="row">
						<div class="col">
							...
							<p class="card-subtitle" style="margin-left: 90px">${routeInfo.airportCodeDep}ICN</p>
						</div>
						<div class="col">
	...
	<div class="d-flex justify-content-center">
		<input type="submit" style="margin-top: 100px"
			class="form-control col-md-2" value="출력">
	</div>
	<!-- Modal -->
	<div class="modal fade" id="ticketPrint" data-backdrop="static"
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<button type="button" class="btn btn-primary col-lg-2"
						data-dismiss="modal" style="float: right;" id="nextButton">Next</button>
				</div>
			</div>
		</div>
	</div>
